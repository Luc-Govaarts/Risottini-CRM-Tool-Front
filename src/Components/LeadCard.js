	...
	return (
		<div>
			<Card>
				<CardHeader
					title={props.lead}
					subtitle={props.associated_company_name}></CardHeader>
				<CardContent>
					<Typography>
					...
					<Box>
						<Container component='main'>
							<div className={classes.paper}>
								...
								<Typography variant='h5'>Pas lead info aan</Typography>
								<DialogContent>
									<DialogContentText>
										Geen enkel veld is verplicht, vul alleen de velden in die je
										wilt aanpassen
									</DialogContentText>
									<form className={classes.form} onSubmit={adjustLeadForm}>
										...
										<TextField
											onChange={(event) =>
												set_company_phone(event.target.value)
											}
											value={company_phone}
											variant='outlined'
											margin='normal'
										...
										<TextField
											onChange={(event) =>
												set_company_address(event.target.value)
											}
			...
			{open_delete ? (
				<div>
					<Dialog open={open_delete} onClose={handleCloseDelete}>
						...
						<DialogContent>
							Weet je zeker dat je deze lead wil verwijderen? alle informatie
							zal dan verloren gaan
						</DialogContent>
						<DialogActions>
